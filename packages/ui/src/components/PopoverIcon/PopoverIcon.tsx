  ...
  return (
    <Popover className="relative">
      ...
      >
        <Popover.Panel
          className={clsx(
            'absolute z-10 mt-2 w-max max-w-xs rounded-lg border border-slate-300 bg-slate-100 p-2 text-sm text-slate-600 shadow-lg dark:border-slate-600 dark:bg-slate-800 dark:text-slate-300',
            {
